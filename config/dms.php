...
return [
    'dms' => [
        ...
        */
        'storage'      => [
            'public-files'  => [
                'dir' => dirname(dirname(__DIR__)) . '/public/files/',
            ],
            'trashed-files' => [
                'dir' => dirname(dirname(__DIR__)) . '/data/trash',
            ],
            'temp-files'    => [
                'dir'             => dirname(dirname(__DIR__)) . '/data/dms/temp-uploads/',
                'upload-expiry'   => 3600,
        ...
        */
        'database'     => [
            'migrations' => [
                'dir'            => dirname(dirname(__DIR__)) . '/database/migrations',
